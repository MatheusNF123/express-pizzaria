...
export class default1674093485707 implements MigrationInterface {
    name = 'default1674093485707'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."orders_status_enum" NOT NULL DEFAULT 'purchased', "date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT '"2023-01-19T01:58:14.364Z"', "totalPrice" numeric(10,2) NOT NULL DEFAULT '0', "user_id" uuid, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
