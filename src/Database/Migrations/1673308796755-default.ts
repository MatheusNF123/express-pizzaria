...
export class default1673308796755 implements MigrationInterface {
    name = 'default1673308796755'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('pending', 'purchased')`);
        await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL NOT NULL, "status" "public"."orders_status_enum" NOT NULL DEFAULT 'pending', "date" TIMESTAMP WITH TIME ZONE, "totalPrice" numeric(10,2) NOT NULL DEFAULT '0', "user_id" integer, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
