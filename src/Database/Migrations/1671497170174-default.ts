...
export class default1671497170174 implements MigrationInterface {
    name = 'default1671497170174'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "pizzas" ("id" SERIAL NOT NULL, "flavor" text NOT NULL, "type" text NOT NULL, "price" numeric(5,2) NOT NULL DEFAULT '0', "ingredients" text NOT NULL, "img" text NOT NULL, CONSTRAINT "PK_27f7ede7b9304d8372a336d1e5d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "orders_pizzas" ADD CONSTRAINT "FK_94e4c78b135471b297ec531c33b" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "orders_pizzas" ADD CONSTRAINT "FK_2e600dd39b600c38d891d3f2adf" FOREIGN KEY ("pizza_id") REFERENCES "pizzas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
