...
export const validationRegister = yup.object().shape({
  firstName: yup.string().min(2, "nome deve ter 2 caracteres no mínimo").required("Este campo é obrigatório"),
  lastName: yup.string().min(2, "nome deve ter 2 caracteres no mínimo").required("Este campo é obrigatório"),
...
export const validationPerfil = yup.object().shape({
  ...
  fullName: yup.string().min(5, "nome deve ter 5 caracteres no mínimo").required("Este campo é obrigatório"),
  address: yup.string().min(2, "address deve ter 2 caracteres no mínimo").required("Este campo é obrigatório"),
  email: yup.string().email("Não e um email valido").required("Este campo é obrigatório"),
  password: yup.string().min(6, "A senha deve ter 6 caracteres no mínimo").required("Este campo é obrigatório"),
  phone: yup.string().matches(
